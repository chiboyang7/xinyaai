...
export const themeParkTasks: Task[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: "小红书是一个传统的APP，里面的内容都是别人创作好之后存在数据库中的，因此我们不同的用户可以看到同样的内容。但豆包是一个AI智能体，没有存储任何做好的内容，所有的内容都是按照要求新生成的。",
        //prompt: "请帮我设计一个Labubu主题乐园的整体布局方案，包括入口设计、3-4个主题区域的规划，以及如何营造神秘森林的沉浸式氛围",
        thinking: "小红书像是一个有了很多书的图书馆，有故事书，图片，还有视频光盘。但豆包是一个印刷厂或者出版社，每一次都会按照我们的要求，重新创作一个作品。"
      }
    ]
  },
  {
